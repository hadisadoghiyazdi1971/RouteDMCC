...
This GitHub package intentionally does not substitute a rewritten implementation for that file. A new implementation, even if mathematically similar, could alter random-number ordering, timing, aggregation, or numerical behavior.
